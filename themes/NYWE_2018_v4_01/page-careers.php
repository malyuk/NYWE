...
<div id="about_banner_image" class="page_banner">
    ...
    <img src="<?php bloginfo('template_url'); ?>/images/banner_careers.jpg" />
</div><!-- banner -->
...
<div id="about">
    ...
    <div id="about_cms_intro">
        ...
        <!-- START wufoo -->
        <div id="wufoo-zut2o9a1coy9vs">
        Fill out my <a href="https://newyorkwineevents.wufoo.com/forms/zut2o9a1coy9vs">online form</a>.
        </div>
        <script type="text/javascript">var zut2o9a1coy9vs;(function(d, t) {
        var s = d.createElement(t), options = {
        'userName':'newyorkwineevents',
        'formHash':'zut2o9a1coy9vs',
        'autoResize':true,
        'height':'692',
        'async':true,
        'host':'wufoo.com',
        ...
        try { zut2o9a1coy9vs = new WufooForm();zut2o9a1coy9vs.initialize(options);zut2o9a1coy9vs.display(); } catch (e) {}};
