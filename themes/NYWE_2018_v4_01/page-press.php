...
// NOTE: This template is a clone of the page-about.php template.
// Its a quick 'hack', the div#id and .class names are all referenced in the styles.css page in context of the parent about page.
?>
	...
	<div id="about">
		...
		<div id="about_contact">
			...
			<div id="about_contact_us">
				...
				<script type="text/javascript">var q1n0dkl20hq397i;
					(function ( d, t ) {
						...
						s.onload = s.onreadystatechange = function () {
							...
							try {
								q1n0dkl20hq397i = new WufooForm();
								q1n0dkl20hq397i.initialize( options );
								q1n0dkl20hq397i.display();
							} catch ( e ) {
							}
						};
