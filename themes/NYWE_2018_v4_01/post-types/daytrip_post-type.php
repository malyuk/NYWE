...
function daytrip_meta_box_cb( $post ) {
    ...
    <div style="margin: 0px 0px 40px 0px; padding: 1em 2em 2em; background: #eff2f5;">
        ...
        <?php if ($daytripSoldout == 'on') : ?>
            ...
            CURRENT STATUS - <input type="checkbox" name="daytripSoldout" id="daytripSoldout" <?php if ( $daytripSoldout == 'on' ) { echo 'CHECKED'; } ?> />
    ...
    <div style="margin: 0px 0px 40px 0px; padding: 1em 2em 2em; background: #eff2f5;">
        ...
        <textarea name="daytripTimePreview" id="daytripTimePreview" cols="65" rows="1"><?php echo $daytripTimePreview; ?></textarea>
        <br />
    ...
    <div style="margin: 0px 0px 40px 0px; padding: 1em 2em 2em; background: #eff2f5;">
        ...
        <input id="daytrip_image" type="text" size="36" style="max-width: 90%;" name="daytrip_image" value="<?php echo $daytrip_image; ?>" /> 
        <input id="upload_daytrip_image" class="button" type="button" value="Upload Image" />	
        <br /><em> - Recommended image proportion of (16:9). Biggest size of 1920 x 1080 pixels, smaller images will also work. ALWAYS OPTIMIZE FOR WEB! AND SAVE AS JPG.</em>
    ...
    <div style="margin: 0px 0px 40px 0px; padding: 1em 2em 2em; background: #eff2f5;">
        ...
        <input id="daytrip_image_logo" type="text" size="36" style="max-width: 90%;" name="daytrip_image_logo" value="<?php echo $daytrip_image_logo; ?>" /> 
  ...
  <div style="margin: 0px 0px 40px 0px; padding: 1em 2em 2em; background: #eff2f5;">
    ...
    <input id="daytripIntroImage" type="text" size="36" style="max-width: 90%;" name="daytripIntroImage" value="<?php echo $daytripIntroImage; ?>" /> 
    ...
    <textarea name="daytripIntroHeading" id="daytripIntroHeading" cols="65" rows="1"><?php echo $daytripIntroHeading; ?></textarea>
    <br /><em>Example: Introduction</em>
    <!-- Text -->
    <h3>Daytrip Intro Text</h3>
    <textarea name="daytripIntroText" id="daytripIntroText" cols="65" rows="4"><?php echo $daytripIntroText; ?></textarea>
    <!-- Item Heading -->
    <h3>Daytrip Intro Item 1 - Heading</h3>
    <textarea name="daytripIntroItem1_heading" id="daytripIntroItem1_heading" cols="65" rows="1"><?php echo $daytripIntroItem1_heading; ?></textarea>
    <!-- Item text -->
    <h3>Daytrip Intro Item 1 - Text</h3>
    <textarea name="daytripIntroItem1_text" id="daytripIntroItem1_text" cols="65" rows="4"><?php echo $daytripIntroItem1_text; ?></textarea>
    <!-- Item2 Heading -->
    <h3>Daytrip Intro Item 2 - Heading</h3>
    <textarea name="daytripIntroItem2_heading" id="daytripIntroItem2_heading" cols="65" rows="1"><?php echo $daytripIntroItem2_heading; ?></textarea>
    <!-- Item2 txt -->
    <h3>Daytrip Intro Item 2 - Text</h3>
    <textarea name="daytripIntroItem2_text" id="daytripIntroItem2_text" cols="65" rows="4"><?php echo $daytripIntroItem2_text; ?></textarea>
  </div><!-- daytripIntro -->
  ...
  <div style="margin: 0px 0px 40px 0px; padding: 1em 2em 2em; background: #eff2f5;">
    ...
    <!-- Heading -->
    <h3>Heading 1</h3>
    <textarea name="daytripTicksInc_heading_1" id="daytripTicksInc_heading_1" cols="65" rows="1"><?php echo $daytripTicksInc_heading_1; ?></textarea>
    <!-- Text -->
    <h3>Text 1</h3>
    <textarea name="daytripTicksInc_text_1" id="daytripTicksInc_text_1" cols="65" rows="4"><?php echo $daytripTicksInc_text_1; ?></textarea>
    <hr />
    <!-- 2 -->
    <!-- Heading -->
    <h3>Heading 2</h3>
    <textarea name="daytripTicksInc_heading_2" id="daytripTicksInc_heading_2" cols="65" rows="1"><?php echo $daytripTicksInc_heading_2; ?></textarea>
    <!-- Text -->
    <h3>Text 2</h3>
    <textarea name="daytripTicksInc_text_2" id="daytripTicksInc_text_2" cols="65" rows="4"><?php echo $daytripTicksInc_text_2; ?></textarea>
    <hr />
    <!-- 3 -->
    <!-- Heading -->
    <h3>Heading 3</h3>
    <textarea name="daytripTicksInc_heading_3" id="daytripTicksInc_heading_3" cols="65" rows="1"><?php echo $daytripTicksInc_heading_3; ?></textarea>
    <!-- Text -->
    <h3>Text 3</h3>
    <textarea name="daytripTicksInc_text_3" id="daytripTicksInc_text_3" cols="65" rows="4"><?php echo $daytripTicksInc_text_3; ?></textarea>
    <hr />
    <!-- 4 -->
    <!-- Heading -->
    <h3>Heading 4</h3>
    <textarea name="daytripTicksInc_heading_4" id="daytripTicksInc_heading_4" cols="65" rows="1"><?php echo $daytripTicksInc_heading_4; ?></textarea>
    <!-- Text -->
    <h3>Text 4</h3>
    <textarea name="daytripTicksInc_text_4" id="daytripTicksInc_text_4" cols="65" rows="4"><?php echo $daytripTicksInc_text_4; ?></textarea>
    <hr />
    <!-- 5 -->
    <!-- Heading -->
    <h3>Heading 5</h3>
    <textarea name="daytripTicksInc_heading_5" id="daytripTicksInc_heading_5" cols="65" rows="1"><?php echo $daytripTicksInc_heading_5; ?></textarea>
    <!-- Text -->
    <h3>Text 5</h3>
    <textarea name="daytripTicksInc_text_5" id="daytripTicksInc_text_5" cols="65" rows="4"><?php echo $daytripTicksInc_text_5; ?></textarea>
    <hr />
    <!-- 6 -->
    <!-- Heading -->
    <h3>Heading 6</h3>
    <textarea name="daytripTicksInc_heading_6" id="daytripTicksInc_heading_6" cols="65" rows="1"><?php echo $daytripTicksInc_heading_6; ?></textarea>
    <!-- Text -->
    <h3>Text 6</h3>
    <textarea name="daytripTicksInc_text_6" id="daytripTicksInc_text_6" cols="65" rows="4"><?php echo $daytripTicksInc_text_6; ?></textarea>
  </div><!-- tickets include -->
  ...
  <div style="margin: 0px 0px 40px 0px; padding: 1em 2em 2em; background: #eff2f5;">
    ...
    <div style="padding: 2%; border: 2px solid #eee; background: #f9f9f9;">
        ...
        <textarea name="daytripFeedback_heading_1" id="daytripFeedback_heading_1" cols="65" rows="1"><?php echo $daytripFeedback_heading_1; ?></textarea>      
        <h3>Client - Card 1</h3>
        <textarea name="daytripFeedback_client_1" id="daytripFeedback_client_1" cols="65" rows="1"><?php echo $daytripFeedback_client_1; ?></textarea>
        <h3>Date - Card 1</h3>
        <textarea name="daytripFeedback_date_1" id="daytripFeedback_date_1" cols="65" rows="1"><?php echo $daytripFeedback_date_1; ?></textarea>
        <h3>Testimonial - Card 1</h3>
        <textarea name="daytripFeedback_excerpt_1" id="daytripFeedback_excerpt_1" cols="65" rows="5"><?php echo $daytripFeedback_excerpt_1; ?></textarea>
    </div>
    <hr />
    <div style="padding: 2%; border: 2px solid #eee; background: #f9f9f9;">
        <h3>Heading - Card 1</h3>
        <textarea name="daytripFeedback_heading_2" id="daytripFeedback_heading_2" cols="65" rows="1"><?php echo $daytripFeedback_heading_2; ?></textarea>      
        <h3>Client - Card 1</h3>
        <textarea name="daytripFeedback_client_2" id="daytripFeedback_client_2" cols="65" rows="1"><?php echo $daytripFeedback_client_2; ?></textarea>
        <h3>Date - Card 1</h3>
        <textarea name="daytripFeedback_date_2" id="daytripFeedback_date_2" cols="65" rows="1"><?php echo $daytripFeedback_date_2; ?></textarea>
        <h3>Testimonial - Card 1</h3>
        <textarea name="daytripFeedback_excerpt_2" id="daytripFeedback_excerpt_2" cols="65" rows="5"><?php echo $daytripFeedback_excerpt_2; ?></textarea>
    </div>
    <hr />
    <div style="padding: 2%; border: 2px solid #eee; background: #f9f9f9;">
        <h3>Heading - Card 1</h3>
        <textarea name="daytripFeedback_heading_3" id="daytripFeedback_heading_3" cols="65" rows="1"><?php echo $daytripFeedback_heading_3; ?></textarea>      
        <h3>Client - Card 1</h3>
        <textarea name="daytripFeedback_client_3" id="daytripFeedback_client_3" cols="65" rows="1"><?php echo $daytripFeedback_client_3; ?></textarea>
        <h3>Date - Card 1</h3>
        <textarea name="daytripFeedback_date_3" id="daytripFeedback_date_3" cols="65" rows="1"><?php echo $daytripFeedback_date_3; ?></textarea>
        <h3>Testimonial - Card 1</h3>
        <textarea name="daytripFeedback_excerpt_3" id="daytripFeedback_excerpt_3" cols="65" rows="5"><?php echo $daytripFeedback_excerpt_3; ?></textarea>
    </div>    
  </div><!-- feedback -->
    ...
    <div style="margin: 0px 0px 40px 0px; padding: 1em 2em 2em; background: #eff2f5;">
        ...
        <h3>Image</h3>
        <input id="daytripMap" type="text" size="36" style="max-width: 90%;" name="daytripMap" value="<?php echo $daytripMap; ?>" /> 
    ...
    <div style="margin: 0px 0px 40px 0px; padding: 1em 2em 2em; background: #eff2f5;">
        <h3>SLIDES</h3>
        <h3>Slide 1</h3>
        <input id="daytripSlide_1" type="text" size="36" style="max-width: 90%;" name="daytripSlide_1" value="<?php echo $daytripSlide_1; ?>" /> 
        ...
        <hr />
        <h3>Slide 2</h3>
        <input id="daytripSlide_2" type="text" size="36" style="max-width: 90%;" name="daytripSlide_2" value="<?php echo $daytripSlide_2; ?>" /> 
        ...
        <hr />
        <h3>Slide 3</h3>
        <input id="daytripSlide_3" type="text" size="36" style="max-width: 90%;" name="daytripSlide_3" value="<?php echo $daytripSlide_3; ?>" /> 
        ...
        <hr />
        <h3>Slide 4</h3>
        <input id="daytripSlide_4" type="text" size="36" style="max-width: 90%;" name="daytripSlide_4" value="<?php echo $daytripSlide_4; ?>" /> 
        ...
        <hr />
        <h3>Slide 5</h3>
        <input id="daytripSlide_5" type="text" size="36" style="max-width: 90%;" name="daytripSlide_5" value="<?php echo $daytripSlide_5; ?>" /> 
    ...
    <div style="margin: 0px 0px 40px 0px; padding: 1em 2em 2em; background: #eff2f5;">
        ...
        <h3>Ticket Price</h3>
        <textarea name="daytripTicketPrice" id="daytripTicketPrice" cols="65" rows="1"><?php echo $daytripTicketPrice; ?></textarea>
        <br /><em>Example: $99</em>  
        <h3>Ticket Heading</h3>
        <textarea name="daytripTicketHeading" id="daytripTicketHeading" cols="65" rows="1"><?php echo $daytripTicketHeading; ?></textarea>
        <br /><em>Example: GET YOUR TICKETS NOW!</em>  
        <h3>Ticket Intro Text</h3>
        <textarea name="daytripTicketText" id="daytripTicketText" cols="65" rows="3"><?php echo $daytripTicketText; ?></textarea>
    ...
    <div style="margin: 0px 0px 40px 0px; padding: 1em 2em 2em; background: #eff2f5;">
        ...
        <div style="padding: 2%; border: 2px solid #eee; background: #f9f9f9;">
            <h3>Entry 1 - Hour</h3>
            <textarea name="daytripTicketTimelineTime_1" id="daytripTicketTimelineTime_1" cols="65" rows="1"><?php echo $daytripTicketTimelineTime_1; ?></textarea>
            <br /><em>Example: 8:30 AM</em>          
            <h3>Entry 1 - Text</h3>
            <textarea name="daytripTicketTimelineText_1" id="daytripTicketTimelineText_1" cols="65" rows="4"><?php echo $daytripTicketTimelineText_1; ?></textarea>
            <br /><em>Example: Gather at the bus terminal at corner of 23rd Street and 5th Avenue.</em>          
        </div>
        <div style="padding: 2%; border: 2px solid #eee; background: #f9f9f9;">
            <h3>Entry 2 - Hour</h3>
            <textarea name="daytripTicketTimelineTime_2" id="daytripTicketTimelineTime_2" cols="65" rows="1"><?php echo $daytripTicketTimelineTime_2; ?></textarea>
            <br /><em>Example: 8:30 AM</em>          
            <h3>Entry 2 - Text</h3>
            <textarea name="daytripTicketTimelineText_2" id="daytripTicketTimelineText_2" cols="65" rows="4"><?php echo $daytripTicketTimelineText_2; ?></textarea>
            <br /><em>Example: Gather at the bus terminal at corner of 23rd Street and 5th Avenue.</em>          
        </div>
        <div style="padding: 2%; border: 2px solid #eee; background: #f9f9f9;">
            <h3>Entry 3 - Hour</h3>
            <textarea name="daytripTicketTimelineTime_3" id="daytripTicketTimelineTime_3" cols="65" rows="1"><?php echo $daytripTicketTimelineTime_3; ?></textarea>
            <br /><em>Example: 8:30 AM</em>          
            <h3>Entry 3 - Text</h3>
            <textarea name="daytripTicketTimelineText_3" id="daytripTicketTimelineText_3" cols="65" rows="4"><?php echo $daytripTicketTimelineText_3; ?></textarea>
            <br /><em>Example: Gather at the bus terminal at corner of 23rd Street and 5th Avenue.</em>          
        </div>
        <div style="padding: 2%; border: 2px solid #eee; background: #f9f9f9;">
            <h3>Entry 4 - Hour</h3>
            <textarea name="daytripTicketTimelineTime_4" id="daytripTicketTimelineTime_4" cols="65" rows="1"><?php echo $daytripTicketTimelineTime_4; ?></textarea>
            <br /><em>Example: 8:30 AM</em>          
            <h3>Entry 4 - Text</h3>
            <textarea name="daytripTicketTimelineText_4" id="daytripTicketTimelineText_4" cols="65" rows="4"><?php echo $daytripTicketTimelineText_4; ?></textarea>
            <br /><em>Example: Gather at the bus terminal at corner of 23rd Street and 5th Avenue.</em>          
        </div>        
        <div style="padding: 2%; border: 2px solid #eee; background: #f9f9f9;">
            <h3>Entry 5 - Hour</h3>
            <textarea name="daytripTicketTimelineTime_5" id="daytripTicketTimelineTime_5" cols="65" rows="1"><?php echo $daytripTicketTimelineTime_5; ?></textarea>
            <br /><em>Example: 8:30 AM</em>          
            <h3>Entry 5 - Text</h3>
            <textarea name="daytripTicketTimelineText_5" id="daytripTicketTimelineText_5" cols="65" rows="4"><?php echo $daytripTicketTimelineText_5; ?></textarea>
            <br /><em>Example: Gather at the bus terminal at corner of 23rd Street and 5th Avenue.</em>          
        </div>
        <div style="padding: 2%; border: 2px solid #eee; background: #f9f9f9;">
            <h3>Entry 6 - Hour</h3>
            <textarea name="daytripTicketTimelineTime_6" id="daytripTicketTimelineTime_6" cols="65" rows="1"><?php echo $daytripTicketTimelineTime_6; ?></textarea>
            <br /><em>Example: 8:30 AM</em>          
            <h3>Entry 6 - Text</h3>
            <textarea name="daytripTicketTimelineText_6" id="daytripTicketTimelineText_6" cols="65" rows="4"><?php echo $daytripTicketTimelineText_6; ?></textarea>
            <br /><em>Example: Gather at the bus terminal at corner of 23rd Street and 5th Avenue.</em>          
        </div>
        <div style="padding: 2%; border: 2px solid #eee; background: #f9f9f9;">
            <h3>Entry 7 - Hour</h3>
            <textarea name="daytripTicketTimelineTime_7" id="daytripTicketTimelineTime_7" cols="65" rows="1"><?php echo $daytripTicketTimelineTime_7; ?></textarea>
            <br /><em>Example: 8:30 AM</em>          
            <h3>Entry 7 - Text</h3>
            <textarea name="daytripTicketTimelineText_7" id="daytripTicketTimelineText_7" cols="65" rows="4"><?php echo $daytripTicketTimelineText_7; ?></textarea>
            <br /><em>Example: Gather at the bus terminal at corner of 23rd Street and 5th Avenue.</em>          
        </div>
        <div style="padding: 2%; border: 2px solid #eee; background: #f9f9f9;">
            <h3>Entry 8 - Hour</h3>
            <textarea name="daytripTicketTimelineTime_8" id="daytripTicketTimelineTime_8" cols="65" rows="1"><?php echo $daytripTicketTimelineTime_8; ?></textarea>
            <br /><em>Example: 8:30 AM</em>          
            <h3>Entry 8 - Text</h3>
            <textarea name="daytripTicketTimelineText_8" id="daytripTicketTimelineText_8" cols="65" rows="4"><?php echo $daytripTicketTimelineText_8; ?></textarea>
            <br /><em>Example: Gather at the bus terminal at corner of 23rd Street and 5th Avenue.</em>          
        </div>
        <div style="padding: 2%; border: 2px solid #eee; background: #f9f9f9;">
            <h3>Entry 9 - Hour</h3>
            <textarea name="daytripTicketTimelineTime_9" id="daytripTicketTimelineTime_9" cols="65" rows="1"><?php echo $daytripTicketTimelineTime_9; ?></textarea>
            <br /><em>Example: 8:30 AM</em>          
            <h3>Entry 9 - Text</h3>
            <textarea name="daytripTicketTimelineText_9" id="daytripTicketTimelineText_9" cols="65" rows="4"><?php echo $daytripTicketTimelineText_9; ?></textarea>
            <br /><em>Example: Gather at the bus terminal at corner of 23rd Street and 5th Avenue.</em>          
        </div>
        <div style="padding: 2%; border: 2px solid #eee; background: #f9f9f9;">
            <h3>Entry 10 - Hour</h3>
            <textarea name="daytripTicketTimelineTime_10" id="daytripTicketTimelineTime_10" cols="65" rows="1"><?php echo $daytripTicketTimelineTime_10; ?></textarea>
            <br /><em>Example: 8:30 AM</em>          
            <h3>Entry 10 - Text</h3>
            <textarea name="daytripTicketTimelineText_10" id="daytripTicketTimelineText_10" cols="65" rows="4"><?php echo $daytripTicketTimelineText_10; ?></textarea>
            <br /><em>Example: Gather at the bus terminal at corner of 23rd Street and 5th Avenue.</em>          
        </div>
    </div><!-- timeline -->
