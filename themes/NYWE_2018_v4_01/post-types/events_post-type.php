...
function v4_event_meta_box_cb( $post ) {
  ...
  <div style="margin: 0px 0px 40px 0px; padding: 1em 2em 2em; background: #eff2f5;">
    ...
    <?php if ($eventSoldout == 'on') : ?>
      ...
      CURRENT STATUS - <input type="checkbox" name="eventSoldout" id="eventSoldout" <?php if ( $eventSoldout == 'on' ) { echo 'CHECKED'; } ?> />
  ...
  <div style="margin: 0px 0px 40px 0px; padding: 1em 2em 2em; background: #eff2f5;">
    <h3>Event Image</h3>
    <input id="events_list_cell_image" type="text" size="36" style="max-width: 90%;" name="events_list_cell_image" value="<?php echo $events_list_cell_image; ?>" /> 
  ...
  <div style="margin: 0px 0px 40px 0px; padding: 1em 2em 2em; background: #eff2f5;">
    <h3>Event Logo</h3>
    <input id="events_list_cell_image_logo" type="text" size="36" style="max-width: 90%;" name="events_list_cell_image_logo" value="<?php echo $events_list_cell_image_logo; ?>" /> 
    <input id="upload_events_list_cell_image_logo" class="button" type="button" value="Upload Image" />	
    <br /><em> - Recommended image size of 200 x 200 pixels. JPG or PNG image formats will work, but for best results, a round PNG image with transparency is suggested.</em>
    <!-- Preview: -->
    <?php 
    if ( $events_list_cell_image ) {
  ...
  <div style="margin: 0px 0px 40px 0px; padding: 1em 2em 2em; background: #eff2f5;">
    ...
    <br />
    <em>* This will show up on the Homepage listings as a brief date desctiption. Note, the event listing logic is based on the POST Published date, not this field.</em>
  </div><!-- event date -->
  ...
  <div style="margin: 0px 0px 40px 0px; padding: 1em 2em 2em; background: #eff2f5;">
    ...
    <textarea name="eventPurchaseLink" id="eventPurchaseLink" cols="65" rows="1"><?php echo $eventPurchaseLink; ?></textarea>
    <br />
  ...
  <div style="margin: 0px 0px 40px 0px; padding: 1em 2em 2em; background: #eff2f5;">
    ...
    <textarea name="eventPresentingSponsorUrl" id="eventPresentingSponsorUrl" cols="65" rows="1"><?php echo $eventPresentingSponsorUrl; ?></textarea>
    <br /><em>Example: http://www.leandroarts.com</em>    
    <h4>Presenting Sponsor Image</h4>
    <input id="eventPresentingSponsor" type="text" size="36" style="max-width: 90%;" name="eventPresentingSponsor" value="<?php echo $eventPresentingSponsor; ?>" /> 
  ...
  <div style="margin: 0px 0px 40px 0px; padding: 1em 2em 2em; background: #eff2f5;">
    ...
    <input id="eventIntroImage" type="text" size="36" style="max-width: 90%;" name="eventIntroImage" value="<?php echo $eventIntroImage; ?>" /> 
    ...
    <textarea name="eventIntroHeading" id="eventIntroHeading" cols="65" rows="1"><?php echo $eventIntroHeading; ?></textarea>
    ...
    <textarea name="eventIntroItem1_heading" id="eventIntroItem1_heading" cols="65" rows="1"><?php echo $eventIntroItem1_heading; ?></textarea>
    
    <h3>Event Intro Item 1 - Text</h3>
    <textarea name="eventIntroItem1_text" id="eventIntroItem1_text" cols="65" rows="4"><?php echo $eventIntroItem1_text; ?></textarea>
    
    <h3>Event Intro Item 2 - Heading</h3>
    <textarea name="eventIntroItem2_heading" id="eventIntroItem2_heading" cols="65" rows="1"><?php echo $eventIntroItem2_heading; ?></textarea>
    
    <h3>Event Intro Item 2 - Text</h3>
    <textarea name="eventIntroItem2_text" id="eventIntroItem2_text" cols="65" rows="4"><?php echo $eventIntroItem2_text; ?></textarea>
  ...
  <div style="margin: 0px 0px 40px 0px; padding: 1em 2em 2em; background: #eff2f5;">
    ...
    <div style="padding: 2%; border: 2px solid #eee; background: #f9f9f9;">
        ...
        <textarea name="eventFeedback_heading_1" id="eventFeedback_heading_1" cols="65" rows="1"><?php echo $eventFeedback_heading_1; ?></textarea>      
        <h3>Client - Card 1</h3>
        <textarea name="eventFeedback_client_1" id="eventFeedback_client_1" cols="65" rows="1"><?php echo $eventFeedback_client_1; ?></textarea>
        <h3>Date - Card 1</h3>
        <textarea name="eventFeedback_date_1" id="eventFeedback_date_1" cols="65" rows="1"><?php echo $eventFeedback_date_1; ?></textarea>
        <h3>Testimonial - Card 1</h3>
        <textarea name="eventFeedback_excerpt_1" id="eventFeedback_excerpt_1" cols="65" rows="5"><?php echo $eventFeedback_excerpt_1; ?></textarea>
    </div>
    <hr />
    <div style="padding: 2%; border: 2px solid #eee; background: #f9f9f9;">
        <h3>Heading - Card 1</h3>
        <textarea name="eventFeedback_heading_2" id="eventFeedback_heading_2" cols="65" rows="1"><?php echo $eventFeedback_heading_2; ?></textarea>      
        <h3>Client - Card 1</h3>
        <textarea name="eventFeedback_client_2" id="eventFeedback_client_2" cols="65" rows="1"><?php echo $eventFeedback_client_2; ?></textarea>
        <h3>Date - Card 1</h3>
        <textarea name="eventFeedback_date_2" id="eventFeedback_date_2" cols="65" rows="1"><?php echo $eventFeedback_date_2; ?></textarea>
        <h3>Testimonial - Card 1</h3>
        <textarea name="eventFeedback_excerpt_2" id="eventFeedback_excerpt_2" cols="65" rows="5"><?php echo $eventFeedback_excerpt_2; ?></textarea>
    </div>
    <hr />
    <div style="padding: 2%; border: 2px solid #eee; background: #f9f9f9;">
        <h3>Heading - Card 1</h3>
        <textarea name="eventFeedback_heading_3" id="eventFeedback_heading_3" cols="65" rows="1"><?php echo $eventFeedback_heading_3; ?></textarea>      
        <h3>Client - Card 1</h3>
        <textarea name="eventFeedback_client_3" id="eventFeedback_client_3" cols="65" rows="1"><?php echo $eventFeedback_client_3; ?></textarea>
        <h3>Date - Card 1</h3>
        <textarea name="eventFeedback_date_3" id="eventFeedback_date_3" cols="65" rows="1"><?php echo $eventFeedback_date_3; ?></textarea>
        <h3>Testimonial - Card 1</h3>
        <textarea name="eventFeedback_excerpt_3" id="eventFeedback_excerpt_3" cols="65" rows="5"><?php echo $eventFeedback_excerpt_3; ?></textarea>
    </div>    
  </div><!-- feedback -->
  ...
  <div style="margin: 0px 0px 40px 0px; padding: 1em 2em 2em; background: #eff2f5;">
    ...
    <h3>Image</h3>
    <input id="eventIntro2Image" type="text" size="36" style="max-width: 90%;" name="eventIntro2Image" value="<?php echo $eventIntro2Image; ?>" /> 
    ...
    <h3>Heading</h3>
    <textarea name="eventIntro2Heading" id="eventIntro2Heading" cols="65" rows="1"><?php echo $eventIntro2Heading; ?></textarea>
  ...
  <div style="margin: 0px 0px 40px 0px; padding: 1em 2em 2em; background: #eff2f5;">
    ...
    <h3>Image</h3>
    <input id="eventIntro3Image" type="text" size="36" style="max-width: 90%;" name="eventIntro3Image" value="<?php echo $eventIntro3Image; ?>" /> 
    ...
    <h3>Heading</h3>
    <textarea name="eventIntro3Heading" id="eventIntro3Heading" cols="65" rows="1"><?php echo $eventIntro3Heading; ?></textarea>
    <br /><em>Example: Continued Description</em>
    <h3>Text Body</h3>
    <?php 
    ...
    <div style="margin: 0px 0px 40px 0px; padding: 1em 2em 2em; background: #eff2f5;">
        ...
        <h3>Image</h3>
        <input id="eventMap" type="text" size="36" style="max-width: 90%;" name="eventMap" value="<?php echo $eventMap; ?>" /> 
        <input id="upload_eventMap" class="button" type="button" value="Upload Image" />	
        <br /><em> - Recommended image size of 1920x 400 pixels. Save as JPG image, ** Always ** Optimize for web (minimum 60% compression).</em>
        <!-- Preview: -->
        <?php 
        if ( $eventMap ) {
  ...
  <h3>TICKET OPTIONS</h3>
        <div style="padding: 2%; border: 2px solid #eee; background: #f9f9f9;">
            <h4>OPTION 1</h4>
            <h3>Sub Heading</h3>
            <input type="text" name="eventTicketsCard_1_subHeading" id="eventTicketsCard_1_subHeading" value="<?php echo $eventTicketsCard_1_subHeading; ?>" size="80" />
            <br /><em> - Example: Our most popular choice!</em>
            <h3>Heading</h3>
            <input type="text" name="eventTicketsCard_1_heading" id="eventTicketsCard_1_heading" value="<?php echo $eventTicketsCard_1_heading; ?>" size="80" />
            <br /><em> - Example: Early Bird</em>
            <h3>Text</h3>
            <input type="text" name="eventTicketsCard_1_text" id="eventTicketsCard_1_text" value="<?php echo $eventTicketsCard_1_text; ?>" size="80" />
            <h3>Price</h3>
            <input type="text" name="eventTicketsCard_1_price" id="eventTicketsCard_1_price" value="<?php echo $eventTicketsCard_1_price; ?>" size="80" />
            <br /><em> - Example: $99</em>
            <h3>Purchase URL</h3>
            <input type="text" name="eventTicketsCard_1_purchase" id="eventTicketsCard_1_purchase" value="<?php echo $eventTicketsCard_1_purchase; ?>" size="80" />
            ...
            <input type="text" name="eventTicketsCard_1_also_1" id="eventTicketsCard_1_also_1" value="<?php echo $eventTicketsCard_1_also_1; ?>" size="80" />
            <h3>Also includes #2</h3>
            <input type="text" name="eventTicketsCard_1_also_2" id="eventTicketsCard_1_also_2" value="<?php echo $eventTicketsCard_1_also_2; ?>" size="80" />
            <h3>Also includes #3</h3>
            <input type="text" name="eventTicketsCard_1_also_3" id="eventTicketsCard_1_also_3" value="<?php echo $eventTicketsCard_1_also_3; ?>" size="80" />
            <h3>Also includes #4</h3>
            <input type="text" name="eventTicketsCard_1_also_4" id="eventTicketsCard_1_also_4" value="<?php echo $eventTicketsCard_1_also_4; ?>" size="80" />
        </div><!-- card -->
        <hr />
        <div style="padding: 2%; border: 2px solid #eee; background: #f9f9f9;">
            <h4>OPTION 2</h4>
            <h3>Sub Heading</h3>
            <input type="text" name="eventTicketsCard_2_subHeading" id="eventTicketsCard_2_subHeading" value="<?php echo $eventTicketsCard_2_subHeading; ?>" size="80" />
            <br /><em> - Example: Our most popular choice!</em>
            <h3>Heading</h3>
            <input type="text" name="eventTicketsCard_2_heading" id="eventTicketsCard_2_heading" value="<?php echo $eventTicketsCard_2_heading; ?>" size="80" />
            <br /><em> - Example: Early Bird</em>
            <h3>Text</h3>
            <input type="text" name="eventTicketsCard_2_text" id="eventTicketsCard_2_text" value="<?php echo $eventTicketsCard_2_text; ?>" size="80" />
            <h3>Price</h3>
            <input type="text" name="eventTicketsCard_2_price" id="eventTicketsCard_2_price" value="<?php echo $eventTicketsCard_2_price; ?>" size="80" />
            <br /><em> - Example: $99</em>
            <h3>Purchase URL</h3>
            <input type="text" name="eventTicketsCard_2_purchase" id="eventTicketsCard_2_purchase" value="<?php echo $eventTicketsCard_2_purchase; ?>" size="80" />
            <br /><em> - Example: http://leandroarts.com</em>
            <br /><em> - If this is left blank, button will be labed as SOLD OUT</em>
            <h3>Also includes #1</h3>
            <input type="text" name="eventTicketsCard_2_also_1" id="eventTicketsCard_2_also_1" value="<?php echo $eventTicketsCard_2_also_1; ?>" size="80" />
            <h3>Also includes #2</h3>
            <input type="text" name="eventTicketsCard_2_also_2" id="eventTicketsCard_2_also_2" value="<?php echo $eventTicketsCard_2_also_2; ?>" size="80" />
            <h3>Also includes #3</h3>
            <input type="text" name="eventTicketsCard_2_also_3" id="eventTicketsCard_2_also_3" value="<?php echo $eventTicketsCard_2_also_3; ?>" size="80" />
            <h3>Also includes #4</h3>
            <input type="text" name="eventTicketsCard_2_also_4" id="eventTicketsCard_2_also_4" value="<?php echo $eventTicketsCard_2_also_4; ?>" size="80" />
        </div><!-- card -->
        <hr />
        <div style="padding: 2%; border: 2px solid #eee; background: #f9f9f9;">
            <h4>OPTION 3</h4>
            <h3>Sub Heading</h3>
            <input type="text" name="eventTicketsCard_3_subHeading" id="eventTicketsCard_3_subHeading" value="<?php echo $eventTicketsCard_3_subHeading; ?>" size="80" />
            <br /><em> - Example: Our most popular choice!</em>
            <h3>Heading</h3>
            <input type="text" name="eventTicketsCard_3_heading" id="eventTicketsCard_3_heading" value="<?php echo $eventTicketsCard_3_heading; ?>" size="80" />
            <br /><em> - Example: Early Bird</em>
            <h3>Text</h3>
            <input type="text" name="eventTicketsCard_3_text" id="eventTicketsCard_3_text" value="<?php echo $eventTicketsCard_3_text; ?>" size="80" />
            <h3>Price</h3>
            <input type="text" name="eventTicketsCard_3_price" id="eventTicketsCard_3_price" value="<?php echo $eventTicketsCard_3_price; ?>" size="80" />
            <br /><em> - Example: $99</em>
            <h3>Purchase URL</h3>
            <input type="text" name="eventTicketsCard_3_purchase" id="eventTicketsCard_3_purchase" value="<?php echo $eventTicketsCard_3_purchase; ?>" size="80" />
            <br /><em> - Example: http://leandroarts.com</em>
            <br /><em> - If this is left blank, button will be labed as SOLD OUT</em>
            <h3>Also includes #1</h3>
            <input type="text" name="eventTicketsCard_3_also_1" id="eventTicketsCard_3_also_1" value="<?php echo $eventTicketsCard_3_also_1; ?>" size="80" />
            <h3>Also includes #2</h3>
            <input type="text" name="eventTicketsCard_3_also_2" id="eventTicketsCard_3_also_2" value="<?php echo $eventTicketsCard_3_also_2; ?>" size="80" />
            <h3>Also includes #3</h3>
            <input type="text" name="eventTicketsCard_3_also_3" id="eventTicketsCard_3_also_3" value="<?php echo $eventTicketsCard_3_also_3; ?>" size="80" />
            <h3>Also includes #4</h3>
            <input type="text" name="eventTicketsCard_3_also_4" id="eventTicketsCard_3_also_4" value="<?php echo $eventTicketsCard_3_also_4; ?>" size="80" />
        </div><!-- card -->
    </div><!-- tickets -->
  ...
  <h3>EVENT SPONSORS</h3>
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <input id="custom_sponsors_1" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_1" value="<?php echo $custom_sponsors_1; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_1" id="custom_sponsors_url_1" value="<?php echo $custom_sponsors_url_1; ?>" size="80" />
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_2" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_2" value="<?php echo $custom_sponsors_2; ?>" /> 
          ...
          ?>            <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_2" id="custom_sponsors_url_2" value="<?php echo $custom_sponsors_url_2; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>   
          <input id="custom_sponsors_3" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_3" value="<?php echo $custom_sponsors_3; ?>" /> 
          ...
          ?>            <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_3" id="custom_sponsors_url_3" value="<?php echo $custom_sponsors_url_3; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_4" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_4" value="<?php echo $custom_sponsors_4; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_4" id="custom_sponsors_url_4" value="<?php echo $custom_sponsors_url_4; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_5" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_5" value="<?php echo $custom_sponsors_5; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_5" id="custom_sponsors_url_5" value="<?php echo $custom_sponsors_url_5; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_6" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_6" value="<?php echo $custom_sponsors_6; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_6" id="custom_sponsors_url_6" value="<?php echo $custom_sponsors_url_6; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_7" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_7" value="<?php echo $custom_sponsors_7; ?>" /> 
          ...
          ?>            <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_7" id="custom_sponsors_url_7" value="<?php echo $custom_sponsors_url_7; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_8" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_8" value="<?php echo $custom_sponsors_8; ?>" /> 
          ...
          ?>            <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_8" id="custom_sponsors_url_8" value="<?php echo $custom_sponsors_url_8; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_9" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_9" value="<?php echo $custom_sponsors_9; ?>" /> 
          ...
          ?>            <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_9" id="custom_sponsors_url_9" value="<?php echo $custom_sponsors_url_9; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_10" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_10" value="<?php echo $custom_sponsors_10; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_10" id="custom_sponsors_url_10" value="<?php echo $custom_sponsors_url_10; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_11" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_11" value="<?php echo $custom_sponsors_11; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_11" id="custom_sponsors_url_11" value="<?php echo $custom_sponsors_url_11; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_12" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_12" value="<?php echo $custom_sponsors_12; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_12" id="custom_sponsors_url_12" value="<?php echo $custom_sponsors_url_12; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_13" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_13" value="<?php echo $custom_sponsors_13; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_13" id="custom_sponsors_url_13" value="<?php echo $custom_sponsors_url_13; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_14" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_14" value="<?php echo $custom_sponsors_14; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_14" id="custom_sponsors_url_14" value="<?php echo $custom_sponsors_url_14; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_15" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_15" value="<?php echo $custom_sponsors_15; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_15" id="custom_sponsors_url_15" value="<?php echo $custom_sponsors_url_15; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_16" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_16" value="<?php echo $custom_sponsors_16; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_16" id="custom_sponsors_url_16" value="<?php echo $custom_sponsors_url_16; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_17" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_17" value="<?php echo $custom_sponsors_17; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_17" id="custom_sponsors_url_17" value="<?php echo $custom_sponsors_url_17; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_18" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_18" value="<?php echo $custom_sponsors_18; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_18" id="custom_sponsors_url_18" value="<?php echo $custom_sponsors_url_18; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_19" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_19" value="<?php echo $custom_sponsors_19; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_19" id="custom_sponsors_url_19" value="<?php echo $custom_sponsors_url_19; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_20" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_20" value="<?php echo $custom_sponsors_20; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_20" id="custom_sponsors_url_20" value="<?php echo $custom_sponsors_url_20; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_21" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_21" value="<?php echo $custom_sponsors_21; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_21" id="custom_sponsors_url_21" value="<?php echo $custom_sponsors_url_21; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_22" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_22" value="<?php echo $custom_sponsors_22; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_22" id="custom_sponsors_url_22" value="<?php echo $custom_sponsors_url_22; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_23" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_23" value="<?php echo $custom_sponsors_23; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_23" id="custom_sponsors_url_23" value="<?php echo $custom_sponsors_url_23; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_24" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_24" value="<?php echo $custom_sponsors_24; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_24" id="custom_sponsors_url_24" value="<?php echo $custom_sponsors_url_24; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_25" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_25" value="<?php echo $custom_sponsors_25; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_25" id="custom_sponsors_url_25" value="<?php echo $custom_sponsors_url_25; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_26" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_26" value="<?php echo $custom_sponsors_2; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_26" id="custom_sponsors_url_26" value="<?php echo $custom_sponsors_url_26; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_27" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_27" value="<?php echo $custom_sponsors_27; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_27" id="custom_sponsors_url_27" value="<?php echo $custom_sponsors_url_27; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_28" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_28" value="<?php echo $custom_sponsors_28; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_28" id="custom_sponsors_url_28" value="<?php echo $custom_sponsors_url_28; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_29" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_29" value="<?php echo $custom_sponsors_29; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_29" id="custom_sponsors_url_29" value="<?php echo $custom_sponsors_url_29; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_30" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_30" value="<?php echo $custom_sponsors_30; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_30" id="custom_sponsors_url_30" value="<?php echo $custom_sponsors_url_30; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_31" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_31" value="<?php echo $custom_sponsors_31; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_31" id="custom_sponsors_url_31" value="<?php echo $custom_sponsors_url_31; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_32" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_32" value="<?php echo $custom_sponsors_32; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_32" id="custom_sponsors_url_32" value="<?php echo $custom_sponsors_url_32; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_33" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_33" value="<?php echo $custom_sponsors_33; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_33" id="custom_sponsors_url_33" value="<?php echo $custom_sponsors_url_33; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_34" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_34" value="<?php echo $custom_sponsors_34; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_34" id="custom_sponsors_url_34" value="<?php echo $custom_sponsors_url_34; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_35" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_35" value="<?php echo $custom_sponsors_35; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_35" id="custom_sponsors_url_35" value="<?php echo $custom_sponsors_url_35; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_36" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_36" value="<?php echo $custom_sponsors_36; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_36" id="custom_sponsors_url_36" value="<?php echo $custom_sponsors_url_36; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_37" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_37" value="<?php echo $custom_sponsors_37; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_37" id="custom_sponsors_url_37" value="<?php echo $custom_sponsors_url_37; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_38" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_38" value="<?php echo $custom_sponsors_38; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_38" id="custom_sponsors_url_38" value="<?php echo $custom_sponsors_url_38; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_39" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_39" value="<?php echo $custom_sponsors_39; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_39" id="custom_sponsors_url_39" value="<?php echo $custom_sponsors_url_39; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_40" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_40" value="<?php echo $custom_sponsors_40; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_40" id="custom_sponsors_url_40" value="<?php echo $custom_sponsors_url_40; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_41" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_41" value="<?php echo $custom_sponsors_41; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_41" id="custom_sponsors_url_41" value="<?php echo $custom_sponsors_url_41; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_42" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_42" value="<?php echo $custom_sponsors_42; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_42" id="custom_sponsors_url_42" value="<?php echo $custom_sponsors_url_42; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_43" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_43" value="<?php echo $custom_sponsors_43; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_43" id="custom_sponsors_url_43" value="<?php echo $custom_sponsors_url_43; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_44" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_44" value="<?php echo $custom_sponsors_44; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_44" id="custom_sponsors_url_44" value="<?php echo $custom_sponsors_url_44; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_45" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_45" value="<?php echo $custom_sponsors_45; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_45" id="custom_sponsors_url_45" value="<?php echo $custom_sponsors_url_45; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_46" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_46" value="<?php echo $custom_sponsors_46; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_46" id="custom_sponsors_url_46" value="<?php echo $custom_sponsors_url_46; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_47" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_47" value="<?php echo $custom_sponsors_47; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_47" id="custom_sponsors_url_47" value="<?php echo $custom_sponsors_url_47; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_48" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_48" value="<?php echo $custom_sponsors_48; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_48" id="custom_sponsors_url_48" value="<?php echo $custom_sponsors_url_48; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_49" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_49" value="<?php echo $custom_sponsors_49; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_49" id="custom_sponsors_url_49" value="<?php echo $custom_sponsors_url_49; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_50" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_50" value="<?php echo $custom_sponsors_50; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_50" id="custom_sponsors_url_50" value="<?php echo $custom_sponsors_url_50; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_51" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_51" value="<?php echo $custom_sponsors_51; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_51" id="custom_sponsors_url_51" value="<?php echo $custom_sponsors_url_51; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_52" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_52" value="<?php echo $custom_sponsors_52; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_52" id="custom_sponsors_url_52" value="<?php echo $custom_sponsors_url_52; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_53" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_53" value="<?php echo $custom_sponsors_53; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_53" id="custom_sponsors_url_53" value="<?php echo $custom_sponsors_url_53; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_54" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_54" value="<?php echo $custom_sponsors_54; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_54" id="custom_sponsors_url_54" value="<?php echo $custom_sponsors_url_54; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_55" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_55" value="<?php echo $custom_sponsors_55; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_55" id="custom_sponsors_url_55" value="<?php echo $custom_sponsors_url_55; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_56" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_56" value="<?php echo $custom_sponsors_56; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_56" id="custom_sponsors_url_56" value="<?php echo $custom_sponsors_url_56; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_57" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_57" value="<?php echo $custom_sponsors_57; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_57" id="custom_sponsors_url_57" value="<?php echo $custom_sponsors_url_57; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_58" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_58" value="<?php echo $custom_sponsors_58; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_58" id="custom_sponsors_url_58" value="<?php echo $custom_sponsors_url_58; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_59" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_59" value="<?php echo $custom_sponsors_59; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_59" id="custom_sponsors_url_59" value="<?php echo $custom_sponsors_url_59; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
      ...
      <div style="padding: 10px; margin: 0px 0px 10px 0px; background: #ffff;">
          ...
          <h5>UPLOAD NEW IMAGE:</h5>
          <input id="custom_sponsors_60" type="text" size="36" style="max-width: 90%;" name="custom_sponsors_60" value="<?php echo $custom_sponsors_60; ?>" /> 
          ...
          <br />
          <h5>URL</h5>
          <input type="text" name="custom_sponsors_url_60" id="custom_sponsors_url_60" value="<?php echo $custom_sponsors_url_60; ?>" size="80" />
          <em> - Example: http://leandroarts.com</em>
          <!-- Logic: -->
          <script type="text/javascript">
              jQuery(document).ready(function(){
