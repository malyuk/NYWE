...
<div id="events">
        ...
        <div id="events_index">
            <?php 
            $events_index = new WP_Query( array( 'post_type' => 'daytrip', 'posts_per_page' => 50 )); 
        ...
        <div id="events_list">
            <?php 
            $events_list = new WP_Query( array( 'post_type' => 'daytrip', 'posts_per_page' => 50 )); 
            ...
            <div class="events_list_cell" id="<?php the_ID(); ?>">
                ...
                if ( is_array($events_list_cell_image_logo) && end($events_list_cell_image_logo) != '' ) { 
                    ...
                    echo '<img class="events_list_cell_image_logo" src="' . get_template_directory_uri()  . '/images/logo_demo.png" />';                    
                }
                ?>         
                <!-- Content -->
                <div class="events_list_cell_content">
                    ...
                    <div class="events_list_cell_image_overlay">
                        ...
                        <h4 class="events_list_cell_image_overlay_time"><?php $eventTimePreview = get_post_custom_values('eventTimePreview'); if ( is_array($eventTimePreview) && end($eventTimePreview) != '' ) { echo end($eventTimePreview); } ?></h4>
                    </div><!-- overlay -->   
                    <div class="events_list_cell_card">                            
                        <h2 class="events_list_cell_card_title"><?php the_title(); ?></h2>
                        <div class="events_list_cell_card_excerpt"><?php the_excerpt(); ?></div>
                        <a class="events_list_cell_card_purchase" href="<?php the_permalink(); ?>">PURCHASE TICKETS</a>
                    </div><!-- card -->
                </div><!-- content -->    
            </div><!-- cell -->                        
            <?php endwhile; ?> 
